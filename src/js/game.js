$.extend(lobby.app, {
  ...
  load: function() {
    lobby.app.ar("load", {
      ...
      width = 20;
      $("#workspace .boxes .boxes-inner .section").each(function() {
        width += parseInt($(this).width() + 21);
      });
  ...
  events: function() {
    ...
    $("#workspace .submit .btn").live("click", function() {
      ...
      if (typeof lobby.app.words[word] != "undefined" && $("#workspace .contents .boxes").find(".box[data-word='" + word + "']").text() == "") {
        ...
        for (var i = 0, len = word.length; i < len; i++) {
          ...
          $("#workspace .contents .boxes").scrollTo(p, {
            duration: 'slow'
          });
        }
